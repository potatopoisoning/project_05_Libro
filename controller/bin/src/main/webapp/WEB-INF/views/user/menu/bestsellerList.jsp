		                    ...
		                    <div class="book-info-container-list">
		                        <div class="book-image">
		                            <a href="product.do?product_no=\${product.product_no}">
		                                <img src="<%=request.getContextPath()%>/upload/\${product.attachment_detail_new_name}" width="200px">
		                            </a>
		                        </div>
  ...
  <div class="search-result-container">
    <div class="result-container">
      ...
      <div id="category-content">
      	<c:forEach items="${bestsellerList}" var="vo">
	      ...
	      <div id="pagination">
			<c:if test="${paging.startPage > 1}">
			  <a href="bestsellerList.do?nowPage=${paging.startPage - 1}">&lt;</a>
			</c:if>	
			...
			<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="cnt">
				...
				<c:if test="${paging.nowPage ne cnt}">
					<a href="bestsellerList.do?nowPage=${cnt}">${cnt}</a>
				</c:if>
			</c:forEach>
				
			<c:if test="${paging.endPage < paging.lastPage}">
			  <a href="bestsellerList.do?nowPage=${paging.endPage + 1}">&gt;</a>
			</c:if>
		  </div>
      </div>
    </div>
